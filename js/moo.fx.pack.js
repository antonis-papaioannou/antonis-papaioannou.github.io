...
Remember.prototype = {
	...
	setCookie: function(value) {
		...
		document.cookie = this.el.id+"_"+this.prefix+"="+value+expires+"; path=/";
	},
	
	remCookie: function(value) { // this function deletes the cookie!
		var date = new Date('2/23/1978');
		var expires = "; expires="+date.toGMTString();
		document.cookie = this.el.id+"_"+this.prefix+"="+value+expires+"; path=/";
	},
	...
	readCookie: function() {
		...
		var nameEQ = this.el.id+"_"+this.prefix+"=";
...
fx.RememberHeight.prototype = Object.extend(new Remember(), {
	...
	tog: function(){ // alternative to toggle that removes cookies on restore height
		if (this.el.offsetHeight == 0) this.remCookie(); // deletes the cookie if height > 0
		else this.setCookie(0);
		this.fx.toggle();
	},
